                  ...
                  {((currentPage - 1) * itemsPerPage + idx) < 2 && (
                    <div className="absolute bottom-0 right-0 bg-white rounded-tl-[32px] pl-3 pt-3 pb-0 pr-0">
                      ...
                      {item.link ? (
                        <a 
                          href={item.link}
                          className="w-[64px] h-[64px] bg-[#101010] group-hover:bg-[var(--color-brand-primary,#b6ef00)] text-[var(--color-brand-primary,#b6ef00)] group-hover:text-[rgb(16,16,16)] rounded-full flex items-center justify-center transition-all duration-300"
                        >
                        ...
                        <div 
                          className="w-[64px] h-[64px] bg-[#101010] group-hover:bg-[var(--color-brand-primary,#b6ef00)] text-[var(--color-brand-primary,#b6ef00)] group-hover:text-[rgb(16,16,16)] rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer"
                        >
                          <svg className="w-6 h-6 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 17L17 7M17 7H7M17 7v10" />
                          </svg>
